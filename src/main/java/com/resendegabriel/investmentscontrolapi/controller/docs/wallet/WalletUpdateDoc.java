...
@Operation(
        summary = "Atualiza uma nova carteira de investimentos",
        description = "Esse endpoint serve para atualizar os dados de uma carteira de investimentos")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
...
public @interface WalletUpdateDoc {
}
