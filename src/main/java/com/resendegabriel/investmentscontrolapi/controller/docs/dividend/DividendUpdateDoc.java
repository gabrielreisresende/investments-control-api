...
@Operation(
        summary = "Atualiza os dados de um dividendo",
        description = "Esse endpoint serve para atualizar a data e valor de um dividendo")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Dados do dividendo atualizados com sucesso.",
                content = @Content(
...
public @interface DividendUpdateDoc {
}
