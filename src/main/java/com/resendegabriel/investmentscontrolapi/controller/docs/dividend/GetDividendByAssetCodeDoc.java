...
@Operation(
        summary = "Retorna uma lista de dividendos a partir de um codigo de ativo",
        description = "Busca todos os dividendos de um ativo pelo codigo de ativo")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Retorna uma lista com os dividendos de um ativo",
                content = @Content(
...
public @interface GetDividendByAssetCodeDoc {
}
